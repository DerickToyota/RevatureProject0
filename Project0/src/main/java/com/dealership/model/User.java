...
public class User extends Object {
    ...
    public User(String username, String password, String[] activities, String phoneNumber, String email) {
        this.username = username;
        this.password = password;
        this.activities = activities;
        this.phoneNumber = phoneNumber;
    ...
    //TODO: reimplement without membership
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;
        User user = (User) o;
        return false; // membership == user.membership && Objects.equals(username, user.username) && Objects.equals(password, user.password) && Arrays.equals(activities, user.activities) && Objects.equals(phoneNumber, user.phoneNumber) && Objects.equals(email, user.email);
    }
